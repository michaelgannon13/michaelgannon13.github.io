function Timeline(cvs) {
    ...
    function init() {
        ...
        try {
            ...
            // vertical lines
            self.lines[0] = new Line(0, canvas.offsetHeight - 100, 'rgba(0, 255, 210, 0.2)', self.options, mouse);
            self.lines[1] = new Line(0, canvas.offsetHeight - 100, 'rgba(13,167,255,0.2)', self.options, mouse);
